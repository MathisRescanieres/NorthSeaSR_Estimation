...
# ================================================================
# PIPELINE : Modèle température complet — XGBoost (OPTIMISÉ RAM)
# ================================================================
...
for (sp in species_list) {
  ...
  # temp_train <- Matrix(data.matrix(spl_full$train[, all_temp_cols]), sparse = TRUE)
  # temp_test <- Matrix(data.matrix(spl_full$test[, all_temp_cols]), sparse = TRUE)
