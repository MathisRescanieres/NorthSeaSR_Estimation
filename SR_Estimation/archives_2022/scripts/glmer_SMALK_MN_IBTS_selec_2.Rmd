...
```{r}
table_cohortes <- read.csv("archives_2022/data/table_cohorte_procedure_selection_2.csv", 
                           header = TRUE, sep = ",",  na ="NA", stringsAsFactors = FALSE)
table_donnees <- read.csv("archives_2022/data/tableau_donnees_procedure_selection_2.csv", 
                          header = TRUE, sep = ",",  na ="NA", stringsAsFactors = FALSE)
```
